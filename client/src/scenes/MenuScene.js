...
export class MenuScene extends Phaser.Scene {
     ...
     * @returns {Phaser.GameObjects.dom} The created domElement object
     */
    ...
    /**
     * Shows the Create Game Form with input fields: username, gameId
     * 
     */
    showCreateGameForm() {
        // Hide menu items
    ...
    /**
     * Shows the Join Game Form with input fields: username, gameId
     * 
     */
    showJoinGameForm() {
        // Hide menu items
    ...
    /**
     * Sets up socket listeners to listen for messages from Server
     * 
     */
    ...
    /**
     * Cleans up/shuts down the socket listeners when scene shuts down
     * 
     */
    shutdown() {
        this.socketListeners.forEach(listener => {
